...
export const PrimeAgentIcon: Icon = ({ className, ...props }) => (
  // Prime Intellect butterfly mark, from prime-agent's own
  // assets/brand/prime-butterfly.svg (theme-tinted like the other marks).
  <svg {...props} viewBox="0 0 178 178" className={cn("fill-black dark:fill-white", className)}>
