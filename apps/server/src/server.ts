...
import { layer as PrimeAgentSessionSyncLive } from "./provider/PrimeAgentSessionSync.ts";
...
const ReactorLayerLive = Layer.empty.pipe(
  ...
  // Prime-agent session files are shared with the TUI; the reactor syncs
  // them before turns and the ingestion advances the cursor after turns.
  Layer.provide(PrimeAgentSessionSyncLive),
);
