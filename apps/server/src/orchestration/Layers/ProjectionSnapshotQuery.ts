    ...
    sql
      .withTransaction(
        Effect.gen(function* () {
          ...
          // The page that reaches the thread's first turn also owns every
          // turnless row older than it — an imported transcript's backfilled
          // messages predate the first real turn and would otherwise be
          // stranded below every page's lower bound.
